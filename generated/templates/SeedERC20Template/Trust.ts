...
export class Notice extends ethereum.Event {
  get params(): Notice__Params {
    return new Notice__Params(this);
  }
}

export class Notice__Params {
  _event: Notice;

  constructor(event: Notice) {
    this._event = event;
  }
...
export class SendNoticeCall extends ethereum.Call {
  get inputs(): SendNoticeCall__Inputs {
    return new SendNoticeCall__Inputs(this);
  }

  get outputs(): SendNoticeCall__Outputs {
    return new SendNoticeCall__Outputs(this);
  }
}

export class SendNoticeCall__Inputs {
  _call: SendNoticeCall;

  constructor(call: SendNoticeCall) {
    this._call = call;
  }
...
export class SendNoticeCall__Outputs {
  _call: SendNoticeCall;
