...
export class Seed extends ethereum.Event {
  get params(): Seed__Params {
    return new Seed__Params(this);
  }
}

export class Seed__Params {
  _event: Seed;

  constructor(event: Seed) {
    this._event = event;
  }
...
export class Unseed extends ethereum.Event {
  get params(): Unseed__Params {
    return new Unseed__Params(this);
  }
}

export class Unseed__Params {
  _event: Unseed;

  constructor(event: Unseed) {
    this._event = event;
  }

  get unseeder(): Address {
    return this._event.parameters[0].value.toAddress();
  }

  get unseedAmounts(): Array<BigInt> {
    return this._event.parameters[1].value.toBigIntArray();
  }
}

export class SeedERC20 extends ethereum.SmartContract {
  static bind(address: Address): SeedERC20 {
    return new SeedERC20("SeedERC20", address);
  }
  ...
  cooldownDuration(): i32 {
    let result = super.call(
      "cooldownDuration",
      "cooldownDuration():(uint16)",
      []
    );
  ...
  try_cooldownDuration(): ethereum.CallResult<i32> {
    let result = super.tryCall(
      "cooldownDuration",
      "cooldownDuration():(uint16)",
      []
...
export class SeedCall extends ethereum.Call {
  get inputs(): SeedCall__Inputs {
    return new SeedCall__Inputs(this);
  }

  get outputs(): SeedCall__Outputs {
    return new SeedCall__Outputs(this);
  }
}

export class SeedCall__Inputs {
  _call: SeedCall;

  constructor(call: SeedCall) {
    this._call = call;
  }

  get minimumUnits_(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get desiredUnits_(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }
}

export class SeedCall__Outputs {
  _call: SeedCall;
...
export class UnseedCall extends ethereum.Call {
  get inputs(): UnseedCall__Inputs {
    return new UnseedCall__Inputs(this);
  }

  get outputs(): UnseedCall__Outputs {
    return new UnseedCall__Outputs(this);
  }
}

export class UnseedCall__Inputs {
  _call: UnseedCall;

  constructor(call: UnseedCall) {
    this._call = call;
  }
...
export class UnseedCall__Outputs {
  _call: UnseedCall;
